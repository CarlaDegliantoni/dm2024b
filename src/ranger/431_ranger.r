...
param <- list(
  "num.trees" = 377, # cantidad de arboles
  "mtry" = 34,  #seleccion de variables/columnas a tomar
  "min.node.size" = 521, # tamaño minimo de las hojas
...
dir.create("./exp/KA4310opt/", showWarnings = FALSE)
archivo_salida <- "./exp/KA4310opt/KA4310_001.opt.csv"
